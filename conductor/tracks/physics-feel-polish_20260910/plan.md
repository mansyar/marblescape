...
- [ ] Task: Write failing tests for per-marble impact throttling (replaces global 60 ms gate)
- [ ] Task: Implement per-marble throttle + lowered gentle-impact cutoff; green
